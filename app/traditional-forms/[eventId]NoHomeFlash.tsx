...
export default function TraditionalFormsScreenNoHomeFlash() {
  ...
  const initializeEventWithGuard = async () => {
    ...
    try {
      console.log('🚀 Starting initialization - ZERO HOME FALLBACK');
      setLoading(true);
      ...
      console.log('🚫 Error occurred - STAYING IN SCREEN, ZERO HOME NAVIGATION');
      setDisplayCompetitors([]);
      setScreenReady(true);
    } finally {
      setLoading(false);
  ...
  // Fix navigation to prevent going to Home
