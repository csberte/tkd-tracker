...
import EditTraditionalFormsModalWithPopup from '../../components/EditTraditionalFormsModalWithPopup';
...
export default function TraditionalFormsScreenShareFixed() {
  ...
  return (
    <View style={traditionalFormsStyles.container}>
      ...
      {selectedCompetitor && (
        <EditTraditionalFormsModalWithPopup 
