...
import TraditionalFormsCompetitorListWithClipboardFix from '../../components/TraditionalFormsCompetitorListWithClipboardFix';
...
export default function TraditionalFormsScreenFinal() {
  ...
  const loadParticipants = async (eventId) => {
    try {
      ...
      // Sort participants by final_rank first (preserves tiebreaker results), then by total_score
  ...
  return (
    <View style={traditionalFormsStyles.container}>
      ...
      >
        ...
        <TraditionalFormsCompetitorListWithClipboardFix
          competitors={participants || []} 
          tieBreakerActive={tieBreakerActive}
          selectedWinners={selectedWinners} 
