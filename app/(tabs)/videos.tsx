...
import VideoActionButtonsWithFullButtons from '../../components/VideoActionButtonsWithFullButtons';
import { 
  VideoData, 
  Competitor, 
  SortOption, 
...
export default function VideosTab() {
  ...
  const loadVideos = async () => {
    ...
    try {
      ...
      }).filter(video => video.video_url && video.competitor_id);

      setVideos(formattedVideos);
      const uniqueCompetitors = getUniqueCompetitors(formattedVideos);
  ...
  return (
    <AnimatedTabScreen direction="left">
      <View style={styles.container}>
        ...
        <ScrollView style={styles.videoList} contentContainerStyle={styles.videoListContent}>
          {loading ? (
              ...
              <View key={video.id} style={styles.videoCard}>
                <View style={styles.cardContent}>
                  ...
                  <View style={styles.rightContent}>
                    <VideoActionButtonsWithFullButtons
                      video={video}
