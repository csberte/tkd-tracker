...
import CompetitorVideosFixed from '../../components/CompetitorVideosFixed';
...
export default function CompetitorDetailFixed() {
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'videos':
        return (
          <View style={styles.tabContent}>
            <CompetitorVideosFixed competitorId={id as string} />
          </View>
        );
      default:
        return null;
