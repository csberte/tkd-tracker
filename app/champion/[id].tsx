...
import ChampionVideosUpdatedComplete from '../../components/ChampionVideosUpdatedComplete';
import ChampionTournamentsListUpdated from '../../components/ChampionTournamentsListUpdated';
import ChampionPointsSummary from '../../components/ChampionPointsSummary';
...
export default function ChampionDetail() {
  ...
  useEffect(() => {
    if (id) {
      console.log('[ChampionDetail] Loading champion with ID:', id);
      loadChampion();
    }
  }, [id]);
  ...
  const loadChampion = async () => {
    try {
      ...
      if (error) {
        ...
        console.log('[ChampionDetail] Loaded champion:', data);
        setChampion(data);
      }
    } catch (error) {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'overview':
        return (
          <View style={styles.tabContent}>
            ...
            <ChampionPointsSummary championId={id as string} />
      ...
      case 'tournaments':
        return (
          <View style={styles.tabContent}>
            <ChampionTournamentsListUpdated championId={id as string} />
          </View>
        );
      case 'videos':
        return (
          <View style={styles.tabContent}>
            <ChampionVideosUpdatedComplete championId={id as string} />
          </View>
        );
    }
  };
