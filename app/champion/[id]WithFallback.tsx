...
export default function ChampionDetailWithFallback() {
  ...
  useEffect(() => {
    if (id) {
      console.log('[ChampionDetailWithFallback] Loading champion with ID:', id);
      loadChampion();
    }
  }, [id]);
  ...
  const loadChampion = async () => {
    try {
      ...
      if (error) {
        ...
        console.log('[ChampionDetailWithFallback] Loaded champion:', data);
        setChampion(data);
      }
    } catch (error) {
