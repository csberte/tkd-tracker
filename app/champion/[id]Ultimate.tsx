...
import ChampionPointsSummaryUltimate from '../../components/ChampionPointsSummaryUltimate';
...
export default function ChampionDetailUltimate() {
  ...
  useEffect(() => {
    if (id) {
      console.log('[ChampionDetailUltimate] Loading champion with ID:', id);
      loadChampion();
    }
  }, [id]);
  ...
  const loadChampion = async () => {
    try {
      ...
      if (error) {
        ...
        console.log('[ChampionDetailUltimate] Loaded champion:', data);
        setChampion(data);
      }
    } catch (error) {
      ...
      case 'overview':
        return (
          <View style={styles.tabContent}>
            ...
            <ChampionPointsSummaryUltimate championId={id as string} />
