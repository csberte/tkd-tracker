...
import ChampionPointsSummaryRebuilt from '../../components/ChampionPointsSummaryRebuilt';
...
export default function ChampionDetailRebuilt() {
  ...
  useEffect(() => {
    if (id) {
      console.log('[ChampionDetailRebuilt] Loading champion with ID:', id);
      loadChampion();
    }
  }, [id]);
  ...
  const loadChampion = async () => {
    try {
      ...
      if (error) {
        ...
        console.log('[ChampionDetailRebuilt] Loaded champion:', data);
        setChampion(data);
      }
    } catch (error) {
      ...
      case 'overview':
        return (
          <View style={styles.tabContent}>
            ...
            <ChampionPointsSummaryRebuilt championId={id as string} />
