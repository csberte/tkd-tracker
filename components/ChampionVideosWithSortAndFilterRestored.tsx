...
interface ChampionVideosWithSortAndFilterRestoredProps {
  championId: string;
}

export default function ChampionVideosWithSortAndFilterRestored({ championId }: ChampionVideosWithSortAndFilterRestoredProps) {
