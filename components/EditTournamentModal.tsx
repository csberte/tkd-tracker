...
export default function EditTournamentModal({ visible, tournament, onClose, onSuccess }: EditTournamentModalProps) {
  ...
  useEffect(() => {
    if (tournament) {
      ...
      setTournamentClass(tournament.class || 'A - Regional');
      setSeason(tournament.season || '2025-2026');
  ...
  const handleSubmit = async () => {
    if (!name.trim() || !date.trim() || !tournament) {
