...
interface TraditionalFormsCompetitorCardEnhancedProps {
...
export default function TraditionalFormsCompetitorCardEnhanced({ 
...
}: TraditionalFormsCompetitorCardEnhancedProps) {
  ...
  // Check if competitor has been scored
  ...
  const seasonalPoints = competitor.points || 0;
            ...
            {isRankFourOrBelow ? (
              <View style={styles.rightAlignedScoreRow}>
                <View style={styles.scoreColumn}>
                  ...
                  {hasBeenScored ? (
                    <Text style={[styles.columnValue, { color: '#D32F2F', fontWeight: 'bold' }]}>{safeCompetitor.totalScore}</Text>
                  ) : (
