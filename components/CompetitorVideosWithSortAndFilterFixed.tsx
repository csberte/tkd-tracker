...
interface CompetitorVideosWithSortAndFilterFixedProps {
  competitorId: string;
}

export default function CompetitorVideosWithSortAndFilterFixed({ competitorId }: CompetitorVideosWithSortAndFilterFixedProps) {
