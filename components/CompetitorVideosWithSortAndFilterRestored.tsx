...
interface CompetitorVideosWithSortAndFilterRestoredProps {
  competitorId: string;
}

export default function CompetitorVideosWithSortAndFilterRestored({ competitorId }: CompetitorVideosWithSortAndFilterRestoredProps) {
