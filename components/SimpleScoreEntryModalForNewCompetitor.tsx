...
interface SimpleScoreEntryModalForNewCompetitorProps {
  visible: boolean;
  onClose: () => void;
...
export default function SimpleScoreEntryModalForNewCompetitor({
  visible,
  onClose,
  competitor,
  eventId,
  onScoreSubmitted
}: SimpleScoreEntryModalForNewCompetitorProps) {
  ...
  const handleSave = async () => {
    try {
      ...
      console.log('Creating event participant for competitor:', competitor.name);
      ...
      console.log('Successfully added competitor to event, participant ID:', participantData.id);
      ...
      console.log('Successfully saved score for new competitor');
      
      // Update final ranks immediately after saving score
      try {
        console.log('Updating final ranks for event:', eventId);
        await updateFinalRanks(eventId);
        console.log('Successfully updated final ranks');
      } catch (rankError) {
        console.error('Error updating final ranks:', rankError);
