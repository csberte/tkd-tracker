...
export default function ScoreCompetitorModal(props: ScoreCompetitorModalProps) {
      ...
      <SafeAreaView style={{ flex: 1 }}>
        <KeyboardAvoidingView behavior="padding" style={{ flex: 1 }}>
          <ScrollView contentContainerStyle={{ padding: 20 }}>
            ...
            <VideoManagementSection competitorId={selectedCompetitor.id} eventId={props.eventId}
              tournamentId={props.tournamentId || ''} scoreId="" competitorName={selectedCompetitor.name}
              eventName="Traditional Forms" judgeScores={[parseInt(judgeAScore) || 0, parseInt(judgeBScore) || 0, parseInt(judgeCScore) || 0]}
              totalScore={parseInt(judgeAScore) + parseInt(judgeBScore) + parseInt(judgeCScore) || 0}
              rank={selectedCompetitor.placement} competitor={selectedCompetitor}
              event={{ name: 'Traditional Forms' }} sortedCompetitors={[]} />
